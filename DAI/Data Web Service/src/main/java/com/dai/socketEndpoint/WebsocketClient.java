package com.dai.socketEndpoint;
...
//TODO create some spring boot magic that will actually listen to the socket on a port
@Component
public class WebsocketClient implements WebSocket.Listener {
    ...
    @Autowired
    public WebsocketClient(SocketMeasurementModel measurementModel) {
    ...
    public CompletionStage<?> onText(WebSocket webSocket, CharSequence data, boolean last) {
        ...
        try {
            measurementModel.saveMeasurement(measurement);
        } catch (Exception e) {
            e.printStackTrace();
        }
